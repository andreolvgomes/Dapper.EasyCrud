    ...
    public class SqlServerTest : StartupDatabase
    {
        ...
        public void Setup()
        {
            ...
            using (var connection = new SqlConnection(Settings.SqlServer()))
            {
                ...
                connection.Execute(@" create table GuidEmpty (Id int IDENTITY(1,1) not null, Identifier [uniqueidentifier] NOT NULL, CONSTRAINT [Id] PRIMARY KEY CLUSTERED ([Id] ASC))");
            }
