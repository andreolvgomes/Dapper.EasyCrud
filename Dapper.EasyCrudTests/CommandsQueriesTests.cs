    ...
    public class CommandsQueriesTests
    {
        ...
        public void TestMassUpdate() //356
        {
            ...
            using (var transaction = connection.BeginTransaction())
            {
                ...
                var user = connection.FindById<User>(id, transaction);
        ...
        public void TestDeleteById()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.Delete<User>(id);
                connection.FindById<User>(id).IsNull();
            }
        }
        ...
        public void TestSimpleGetList()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.All<User>(new { });
        ...
        public void TestFilteredGetList()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.All<User>(new { Age = 10 });
        ...
        public void TestFilteredGetListWithMultipleKeys()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var keyMasters = connection.All<KeyMaster>(new { Key1 = 1 });
        ...
        public void TestGetListWithNullWhere()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.All<User>(null);
        ...
        public void TestUpdateWithReadonlyProperty()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                user = connection.FindById<User>(id);
        ...
        public void TestUpdate()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var newitem = connection.FindById<Car>(newid);
                newitem.Make = "Toyota";
                connection.Update(newitem);
                var updateditem = connection.FindById<Car>(newid);
        ...
        public void TestUpdateUsingGenericLimitedFields()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                //act
                var insertedUser = connection.FindById<User>(user.Id);
        ...
        public void TestDeleteByObjectWithAttributes()
        {
            ...
            {
                var id = connection.Insert(new Car { Make = "Honda", Model = "Civic" });
                var car = connection.FindById<Car>(id);
                connection.Delete(car);
                connection.FindById<Car>(id).IsNull();
            }
        }
        ...
        public void TestDeleteByMultipleKeyObjectWithAttributes()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var car = connection.FindById<KeyMaster>(new { Key1 = 1, Key2 = 2 });
                connection.Delete(car);
                connection.FindById<KeyMaster>(keyMaster).IsNull();
            }
        }
        ...
        public void TestComplexTypesMarkedEditableAreSaved()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user1 = connection.FindById<User>(id);
        ...
        public void TestNullableSimpleTypesAreSaved()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user1 = connection.FindById<User1>(id);
        ...
        public void TestGetFromDifferentSchema()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var carlog = connection.FindById<CarLog>(id);
        ...
        public void TestTryingToGetFromTableInSchemaWithoutDataAnnotationShouldFail()
        {
            using (var connection = GetOpenConnection())
            {
                try
                {
                    connection.FindById<SchemalessCarLog>(1);
                }
                catch (Exception)
                {
        ...
        public void TestGetFromTableWithNonIntPrimaryKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var city = connection.FindById<City>("Morgantown");
        ...
        public void TestDeleteFromTableWithNonIntPrimaryKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.Delete<City>((object)"Fairmont").IsEqualTo(1);
            }
        }
        ...
        public void TestNullableEnumInsert()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.All<User>(new { Name = "Enum-y" }).FirstOrDefault() ?? new User();
        ...
        {
            DapperEasyCrud.SetDialect(Dialect.SQLServer);
            DapperEasyCrud.GetDialect().IsEqualTo(Dialect.SQLServer.ToString());
            DapperEasyCrud.SetDialect(Dialect.PostgreSQL);
            DapperEasyCrud.GetDialect().IsEqualTo(Dialect.PostgreSQL.ToString());
        }
        ...
        public void TestInsertIntoTableWithUnspecifiedGuidKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                //var id2 = connection.Insert<Guid, Pessoa>(new Pessoa
                //{
                //    Id = Guid.NewGuid(),
                //    Nome = "Pessoa " + new Random().Next(0, 90000),
                //    Idade = new Random().Next(0, 99)
                //});
                //var record2 = connection.Find<Pessoa>(id2);
            }
        }
        ...
        public void TestMultiInsertASync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var list = connection.All<User>(new { Age = 10 });
        ...
        public void TestSimpleGetAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.FindByIdAsync<User>(id);
        ...
        public void TestMultipleKeyGetAsync()
        {
            using (var connection = GetOpenConnection())
            {
                var keyMaster = new KeyMaster { Key1 = 1, Key2 = 2 };
                connection.Insert(keyMaster);
                var result = connection.FindByIdAsync<KeyMaster>(new { Key1 = 1, Key2 = 2 });
        ...
        public void TestDeleteByMultipleKeyObject()
        {
            using (var connection = GetOpenConnection())
            {
                var keyMaster = new KeyMaster { Key1 = 1, Key2 = 2 };
                connection.Insert(keyMaster);
                connection.FindById<KeyMaster>(keyMaster);
        ...
        public void TestSimpleGetListAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.AllAsync<User>(new { });
        ...
        public void TestFilteredGetListAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.AllAsync<User>(new { Age = 10 });
        ...
        public void TestFilteredGetListParametersAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.AllAsync<User>("where Age = @Age", new { Age = 10 });
                user.Result.Count().IsEqualTo(3);
                connection.Execute("Delete from Users");
            }
        }
        ...
        public void TestRecordCountAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.CountAsync<User>().Result.IsEqualTo(30);

                connection.CountAsync<User>("where age = 10 or age = 11").Result.IsEqualTo(2);
        ...
        public void TestRecordCountByObjectAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.CountAsync<User>(new { age = 10 }).Result.IsEqualTo(1);
        ...
        public void TestInsertWithSpecifiedPrimaryKeyAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var user = connection.FindByIdAsync<UserWithoutAutoIdentity>(999);
        ...
        public void TestDeleteByObjectWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var strange = connection.FindById<StrangeColumnNames>(itemId);
                connection.Delete(strange);
                connection.FindById<StrangeColumnNames>(itemId).IsNull();
            }
        }
        ...
        public void TestSimpleGetListWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var strange = connection.All<StrangeColumnNames>(new { });
        ...
        public void TestUpdateWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var newitem = connection.FindById<StrangeColumnNames>(newid);
                newitem.Word = "Word Update";
                connection.Update(newitem);
                var updateditem = connection.FindById<StrangeColumnNames>(newid);
        ...
        public void TestFilteredGetListWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var strange = connection.All<StrangeColumnNames>(new { StrangeWord = "Strange 2" });
        ...
        public void TestGetListPaged()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.AllPaged<User>(2, 10, null, null);
        ...
        public void TestGetListPagedWithParameters()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.AllPaged<User>(1, 30, "where Age > @Age", null, new { Age = 14 });
        ...
        public void TestGetListPagedWithSpecifiedPrimaryKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.AllPaged<StrangeColumnNames>(2, 10, null, null);
                resultlist.Count().IsEqualTo(10);
        ...
        public void TestGetListPagedWithWhereClause()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist1 = connection.AllPaged<User>(1, 3, "Where Name LIKE 'Person 2%'", "age desc");
                resultlist1.Count().IsEqualTo(3);

                var resultlist = connection.AllPaged<User>(2, 3, "Where Name LIKE 'Person 2%'", "age desc");
        ...
        public void TestRecordCountWhereClause()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.All<User>();
                resultlist.Count().IsEqualTo(30);
                connection.Count<User>().IsEqualTo(30);

                connection.Count<User>("where age = 10 or age = 11").IsEqualTo(2);
        ...
        public void TestRecordCountWhereObject()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.Count<User>(new { age = 10 }).IsEqualTo(1);
        ...
        public void TestRecordCountParameters()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.All<User>();
                resultlist.Count().IsEqualTo(30);
                connection.Count<User>("where Age > 15").IsEqualTo(14);
        ...
        public void TestInsertWithSpecifiedPrimaryKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                id.IsEqualTo(999);
                var user = connection.FindById<UserWithoutAutoIdentity>(999);
        ...
        public void TestGetListNullableWhere()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var list = connection.All<User>(new { ScheduledDayOff = (DayOfWeek?)null });
                list.Count().IsEqualTo(1);


                // test with db.null value
                list = connection.All<User>(new { ScheduledDayOff = DBNull.Value });
                list.Count().IsEqualTo(1);
        ...
        public void IgnoreProperties()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var item = connection.FindById<IgnoreColumns>(itemId);
                ...
                item = connection.FindById<IgnoreColumns>(itemId);
